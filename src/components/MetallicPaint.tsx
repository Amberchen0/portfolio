...
export default function MetallicPaint({
  ...
  useEffect(() => {
    ...
    /* listen on WINDOW so the ripple fires even when the canvas is
       covered by pointer-events:none parents or sibling hit-targets
       with higher z-index (e.g. the hero hover lens hotspot). */
